...
forwarding_policy_for_s3 = IfThenElse(PortEq(1),SetPort(2,3),IfThenElse(IP4DstEq("10.0.0.3"),IfThenElse(TCPDstPortEq(10000),SetPort(1),SetPort(9999)),SetPort(9999)))
