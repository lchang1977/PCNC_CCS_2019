...
p = SetPort(1)|SetIP4Dst("10.0.0.5")>>SetPort(1)
tp = IfThenElse(IP4DstEq("10.0.0.3") & TCPDstPortEq(10000),p,SetPort(9999))
temp = IfThenElse(IP4DstEq("10.0.0.4") & TCPDstPortEq(11000),SetPort(1),tp)
forwarding_policy_for_s3 = IfThenElse(PortEq(1),SetPort(2,3),temp)
